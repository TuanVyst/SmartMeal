  ...
  Widget build(BuildContext context) {
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          // Header
          Text('Nhật ký dinh dưỡng', style: AppTextStyles.pageTitle),
          const SizedBox(height: 4),
          Text('Theo dõi lượng dinh dưỡng hàng ngày', style: AppTextStyles.bodySmall),
          ...
          Row(
            ...
            children: [
              Text('Hôm nay', style: AppTextStyles.sectionTitle),
              Container(
            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  const SizedBox(height: 12),
                  Text('Chưa có bữa ăn nào', style: AppTextStyles.bodyMedium),
                  const SizedBox(height: 4),
                  Text('Nhấn + để thêm bữa ăn đầu tiên', style: AppTextStyles.bodySmall),
                ],
              ),
            )
          else
        ...
        children: [
          ...
          Expanded(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text('${(log.totalCalories ?? 0).round()} kcal', style: AppTextStyles.bodyMedium.copyWith(fontWeight: FontWeight.w700)),
