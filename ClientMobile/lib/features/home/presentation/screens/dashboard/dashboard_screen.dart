...
import 'package:smart_meal/features/diary/domain/nutrition_log_model.dart';
import 'package:smart_meal/features/nutrition/domain/nutrition_goal_model.dart';
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                gradient: RadialGradient(
                  colors: [const Color(0xFF6CCB63).withValues(alpha: 0.25), Colors.transparent],
                ),
              ),
            ),
          ),
          Positioned(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                shape: BoxShape.circle,
                gradient: RadialGradient(
                  colors: [const Color(0xFFA8E6A1).withValues(alpha: 0.3), Colors.transparent],
                ),
              ),
            ),
          ),
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Text('Chào mừng trở lại', style: AppTypography.heroTag),
                      ),
                      const SizedBox(height: 12),
                      ...
                      Container(
                        decoration: BoxDecoration(
                          ...
                          boxShadow: [
                            BoxShadow(
                              color: const Color(0xFF6CCB63).withValues(alpha: 0.45),
                              blurRadius: 24,
                        ...
                        child: Material(
                          ...
                          child: InkWell(
                            ...
                            child: Padding(
                              ...
                              child: Text('Khám phá món ăn', style: AppTypography.button),
                            ),
                          ),
                        ),
                      ),
    ...
    return Row(
      ...
      children: [
        ...
        if (actionText != null)
          GestureDetector(
            onTap: onAction,
            child: Text(actionText, style: AppTypography.sectionSeeAll),
          )
